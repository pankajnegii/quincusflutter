          ...
          children: <Widget>[
            new Padding(padding: EdgeInsets.only(left: 30.0),
              child: RaisedButton(
                ...
                color: greenColor(),
                child: Text('COMPLETE', style: TextStyle(fontSize: 18.0, fontWeight: FontWeight.w400),),
                onPressed: () {},
              ),
            ),
          ...
          new Container(
            ...
            child: Container(
              ...
              constraints: BoxConstraints(
                  maxHeight: visibilityDetails ? 347.0 : 224,
                  maxWidth: 440.0,
                  minWidth: 150.0,
                  minHeight: 150.0
              ),
                        ...
                        Expanded(
                          ...
                          child: Padding(
                            ...
                            child: new Text(
                              ...
                              maxLines: 3, style: TextStyle(fontSize: 15.0,),),
                          ),
                        ),
